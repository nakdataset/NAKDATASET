...
/*====================================================================*/
/**
 * LoadDialog for up-/down-loading a database to a SIARD archive. Abstract base
 * class for DownloadDialog and UploadDialog.
 * 
...
public abstract class LoadDialog extends ScrollableDialog implements EventHandler<WindowEvent>
{
	...
	/*------------------------------------------------------------------*/
	/**
	 * create a label with the given text and set its preferred width to the text
	 * width.
	 * 
	...
	/*------------------------------------------------------------------*/
	/**
	 * create a label with the given text followed by a colon, set its preferred
	 * width to the text width and set its alignment to right.
	 * 
	 * @param sText text for label.
	 * @return new label.
	 */
	 ...
	 */
	protected abstract VBox createVBoxParameters(Connection conn, Archive archive, boolean bMetaDataOnly,
	        boolean bViewsAsTables);

	/*------------------------------------------------------------------*/
	/**
	 * create the main VBox of the dialog containing title area, text area, progress
	 * bar, separator and OK and Cancel buttons.
	 * 
	 * @param conn           database connection.
	 * @param fileArchive    SIARD archive to be written.
	 * @param bMetaDataOnly  true, if only meta data are to be up- or downloaded.
	 ...
	 */
	protected VBox createVBoxDialog(Connection conn, Archive archive, boolean bMetaDataOnly, boolean bViewsAsTables)
	{
		/*
		 * VBox for title area, text area, progress bar, message, separator and OK and
		 * Cancel buttons
		 */
		VBox vbox = new VBox();
		...
		// dialog parameters
		VBox	vboxParameters	= createVBoxParameters(conn, archive, bMetaDataOnly, bViewsAsTables);
	 ...
	 * @param bViewsAsTables true, if views are to be downloaded as tables.
	 */
	protected LoadDialog(Stage stageOwner, Connection conn, Archive archive, boolean bMetaDataOnly,
	        boolean bViewsAsTables, String sTitle)
	{
