...
/*====================================================================*/
/**
 * DownloadConnectionDialog for entering data to connect to a database for
 * download.
 * 
 * @author Hartwig Thomas
 */
public class DownloadConnectionDialog extends ConnectionDialog
{
	...
	{
		super(stageOwner, sConnectionUrl, sDbUser, _sb.getConnectionDownloadTitle(),
		        _sb.getConnectionDownloadMetaDataOnlyLabel(), _sb.getConnectionDownloadMetaDataOnlyTooltip(), null,
		        null, _sb.getConnectionDownloadViewsAsTablesLabel(), _sb.getConnectionDownloadViewsAsTablesTooltip());
	 ...
	 * @param sConnectionUrl initial value for connection (JDBC) URL or null.
	 * @param sDbUser        initial value for user of database or null.
	 * @return DownloadConnectionDialog instance with results. if getResult() is 1
	 *         then getConnectionUrl(), getDbUser(), getDbPassword(),
	 *         isMetaDataOnly() and isViewsAsTables() have the values entered.
	 */
	public static DownloadConnectionDialog showDownloadConnectionDialog(Stage stageOwner, String sConnectionUrl,
	        String sDbUser)
	{
