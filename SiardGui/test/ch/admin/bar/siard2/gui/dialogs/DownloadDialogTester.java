...
public class DownloadDialogTester extends Application
{
	/** return codes */
	...
	public static void main(String[] args)
	{
		...
		try
		{
			// Problem: if there are two classes extending Application, we must load the
			// ancillary one first
			try
			{
				Class.forName("ch.admin.bar.siard2.gui.SiardGui");
			}
