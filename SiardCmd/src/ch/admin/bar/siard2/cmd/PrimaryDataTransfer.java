...
public class PrimaryDataTransfer
{
	...
	private static IndentLogger	_il						= IndentLogger
	        .getIndentLogger(PrimaryDataTransfer.class.getName());
	 ...
	 */
	protected PrimaryDataTransfer(Connection conn, Archive archive, ArchiveMapping am, boolean bSupportsArrays,
	        boolean bSupportsDistincts, boolean bSupportsUdts)
	{
		_conn				= conn;
		_archive			= archive;
		_am					= am;
