...
{
	private static IndentLogger		log						= IndentLogger.getIndentLogger(SftpFileDownload.class.getName());
	...
	public SftpFileDownload(String host, String userName, String password, int port)
	{
		JSch jsch = new JSch();
		try
		{
	...
	public void download(String dir, String downloadFileName, String path)
	{
		...
		{
			System.err.println("SFTP ERROR 디렉토리나 파일을 찾을수 없습니다.(" + dir + ", " + downloadFileName + ")");			
			e.printStackTrace();
		}
		...
		try
		{
			...
			System.out.println("  Current File Size " + fileSizeToStr(SftpFileDownload.fileSize) + " (" + sw.formatRate(SftpFileDownload.fileSize, sw.stop()) + " kB/s)");
			/* E: 현재 파일 전송속도 춮력 */
