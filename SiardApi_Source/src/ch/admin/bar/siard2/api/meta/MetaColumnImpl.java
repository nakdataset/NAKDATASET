...
public class MetaColumnImpl extends MetaValueImpl implements MetaColumn
{
	...
	{
		//System.out.println("MetaColumnImpl getMetaFieldsMap");
	...
	{
		//System.out.println("MetaColumnImpl setTemplate");
	...
	{
		//System.out.println("MetaColumnImpl openMetaFields");
		
		FieldsType fts = _ct.getFields();
		//System.out.println("MetaColumnImpl openMetaFields fts=" + fts);
		if (fts != null)
		{
			for (int iField = 0; iField < fts.getField().size(); iField++)
			{
				...
				//System.out.println("MetaColumnImpl openMetaFields mf.getName()=" + mf.getName());
			}
		}
	} /* openMetaFields */
	 ...
	 * @throws IOException if the existing field meta data could not be matched to
	 *                     attributes.
	 */
	private MetaColumnImpl(MetaTable mtParent, ColumnType ct, int iPosition) throws IOException
	{
		super(iPosition);
		//System.out.println("MetaColumnImpl MetaColumnImpl");
		_mtParent = mtParent;
		_ct = ct;
	...
	{
		//System.out.println("MetaColumnImpl newInstance");
	...
	{
		//System.out.println("MetaColumnImpl getName");
		return XU.fromXml(_ct.getName());
	}

	/*------------------------------------------------------------------*/
	/**
	 * get relative internal lob folder for this column or null, if it is the column
	 * of a view or an external LOB folder is set.
	 * 
	 * @return relative internal lob folder.
	 */
	public String getFolder()
	{
		//System.out.println("MetaColumnImpl getFolder");
		String sFolder = null;
	...
	{
		//System.out.println("MetaColumnImpl setLobFolder");
		...
		if (bMayBeSet)
		{
			if (getArchiveImpl().isMetaDataDifferent(getLobFolder(), uriLobFolder))
			{
				...
				{
					MetaDataImpl mdi = (MetaDataImpl) (getParentMetaTable().getTable().getParentSchema()
							.getParentArchive().getMetaData());
					if (uriLobFolder.getPath().endsWith("/"))
					{
						if (uriLobFolder.isAbsolute())
						{
							if (uriLobFolder.getScheme() == null)
							{
								try
								{
									uriLobFolder = new URI(MetaDataImpl._sURI_SCHEME_FILE, "", uriLobFolder.getPath(),
											null);
								}
							...
							if (!uriLobFolder.getScheme().equals(MetaDataImpl._sURI_SCHEME_FILE))
								throw new IllegalArgumentException("Only URIs with scheme \""
										+ MetaDataImpl._sURI_SCHEME_FILE + "\" allowed for LOB folder!");
						}
						...
						throw new IllegalArgumentException(
								"Path of LOB folder URI must denote a folder (end with \"/\")!");
				}
				else
	...
	{
		//System.out.println("MetaColumnImpl getLobFolder");
	...
	{
		//System.out.println("MetaColumnImpl getAbsoluteLobFolder");
	...
	{
		//System.out.println("MetaColumnImpl setType");
	...
	{
		//System.out.println("MetaColumnImpl setPreType");
	...
	{
		//System.out.println("MetaColumnImpl getType");
	...
	{
		//System.out.println("MetaColumnImpl getPreType");
	...
	{
		//System.out.println("MetaColumnImpl getLength");
		long lLength = -1;
		MetaType mt = getMetaType();
		CategoryType cat = null;
		if (mt != null)
	...
	{
		//System.out.println("MetaColumnImpl getScale");
	...
	{
		//System.out.println("MetaColumnImpl setTypeOriginal");
	...
	{
		//System.out.println("MetaColumnImpl getTypeOriginal");
	...
	{
		//System.out.println("MetaColumnImpl setNullable");
	...
	{
		//System.out.println("MetaColumnImpl isNullable");
	...
	{
		//System.out.println("MetaColumnImpl setDefaultValue");
	...
	{
		//System.out.println("MetaColumnImpl getDefaultValue");
	...
	{
		//System.out.println("MetaColumnImpl setMimeType");
		if (getArchiveImpl().canModifyPrimaryData())
		{
	...
	{
		//System.out.println("MetaColumnImpl getMimeType");
	...
	{
		//System.out.println("MetaColumnImpl setTypeSchema");
	...
	{
		//System.out.println("MetaColumnImpl getTypeSchema");
	...
	{
		//System.out.println("MetaColumnImpl setTypeName");
	...
	{
		//System.out.println("MetaColumnImpl getTypeName");
	...
	{
		//System.out.println("MetaColumnImpl getMetaType");
	...
	{
		//System.out.println("MetaColumnImpl getMetaFields");
	...
	{
		//System.out.println("MetaColumnImpl getMetaField");
	...
	{
		//System.out.println("MetaColumnImpl createMetaField");
	...
	{
		//System.out.println("MetaColumnImpl setCardinality");
	...
	{
		//System.out.println("MetaColumnImpl getCardinality");
	...
	{
		//System.out.println("MetaColumnImpl setDescription");
	...
	{
		//System.out.println("MetaColumnImpl getDescription");
	...
	{
		//System.out.println("MetaColumnImpl getSearchElements");
		
		return new String[] { getName(), String.valueOf(getPosition()),
				getLobFolder() == null ? "" : getLobFolder().toString(), getMimeType(), getType(), getTypeSchema(),
				getTypeName(), getTypeOriginal(), String.valueOf(isNullable()), getDefaultValue(),
				(getCardinality() <= 0) ? "" : String.valueOf(getCardinality()), getDescription() };
	} /* getSearchElements */

	/*------------------------------------------------------------------*/
	/**
	 * {@inheritDoc} toString() returns the name of the column which is to be
	 * displayed as the label of the column node of the tree displaying the archive.
	 */
	@Override
	public String toString()
	{
		//System.out.println("MetaColumnImpl toString");
