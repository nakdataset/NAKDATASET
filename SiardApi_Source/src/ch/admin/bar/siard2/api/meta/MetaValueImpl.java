 ...
 */
public abstract class MetaValueImpl extends MetaSearchImpl implements MetaValue
{
	...
	public List<List<String>> getNames(boolean bSupportsArrays, boolean bSupportsUdts) throws IOException
	{
		...
		if (((getCardinality() < 0) && (getMetaFields() == 0)) || ((getCardinality() >= 0) && bSupportsArrays)
	...
	public long getMaxLength() throws IOException
	{
		...
		if (l == -1)
		{
			...
			if ((iDataType == java.sql.Types.CHAR) || (iDataType == java.sql.Types.NCHAR)
