...
@XmlType(name = "routineType", namespace = "http://www.bar.admin.ch/xmlns/siard/1.0/metadata.xsd", propOrder = { "name", "description", "source", "body", "characteristic", "returnType", "parameters" })
