...
@XmlType(name = "tableType", namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd", propOrder = { "name", "folder", "description", "columns", "primaryKey", "foreignKeys", "candidateKeys", "checkConstraints", "triggers", "rows" })
public class TableType
{
    ...
    public void setPrimaryKey(final UniqueKeyType value) {
