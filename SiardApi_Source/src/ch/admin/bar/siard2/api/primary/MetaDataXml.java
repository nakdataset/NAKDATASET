...
public class MetaDataXml
{
	...
	private static CandidateKeysType convertCandidateKeys(
	        ch.admin.bar.siard2.api.generated.old10.CandidateKeysType cktsOld)
	{
	...
	private static CheckConstraintType convertCheckConstraint(
	        ch.admin.bar.siard2.api.generated.old10.CheckConstraintType cctOld)
	{
	...
	private static CheckConstraintsType convertCheckConstraints(
	        ch.admin.bar.siard2.api.generated.old10.CheckConstraintsType cctsOld)
	{
	...
	/*------------------------------------------------------------------*/
	/**
	 * read an "old" meta data XML file using SIARD Format version 1.0 and convert
	 * it to the current format.
	 * 
	 * @param isXml input stream to read.
	 * @return meta data in current format or null, if it did not conform to SIARD
	 *         Format 1.0.
	 */
	public static SiardArchive readXmlOld10(InputStream isXml)
	{
		...
		try
		{
			URL														urlXsd	= Archive.class
			        .getResource(sSIARD10_XSD_RESOURCE);
			ch.admin.bar.siard2.api.generated.old10.SiardArchive	saOld10	= Io
			        .readJaxbObject(ch.admin.bar.siard2.api.generated.old10.SiardArchive.class, isXml, urlXsd);
			if (saOld10 != null)
			{
	...
	/*------------------------------------------------------------------*/
	/**
	 * write a meta data XML file in the current SIARD Format 2.1 validating it
	 * while you write.
	 * 
	 * @param sa    JAXB SIARD meta data object.
	 * @param osXml Output stream to write XML to.
	 * @throws JAXBException if SIARD object did not conform the current format.
	 */
